...
$(function(){
	...
	// also note that both custom events use easing...
	// easing is the method the effects are done.
	// swing i think speeds ups initial and slows down at the end.
	// linear is a smooth swing.
});